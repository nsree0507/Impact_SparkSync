...
# -----------------------------
app.include_router(location_router, prefix="/location", tags=["Location Services"])
app.include_router(customer_router, prefix="/customer", tags=["Customer Services"])
app.include_router(admin_router, prefix="/admin", tags=["Admin Services"])
